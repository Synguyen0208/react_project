                ...
                <tbody>
                    {this.props.data.map(value1 => {
                        return (<tr>
                            ...
                            <td>
                                <button style={{ display: this.props.update }} name="add" value={value1.id} onClick={() => {if(value1.id!=undefined){this.props.change(value1.id)} else this.props.change(value1.code)}}><img src="https://taiwebs.com/upload/icons/systemmodeler.png" style={{ width: "2rem" }}></img></button>
                                ...
                                {this.props.view != null &&
                                    <Link onClick={()=>this.props.detail("order_detail", value1.id)}>View details</Link>
                                }
                            </td>
                        </tr>)
                    })}
