...
class Confirm extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if(this.state.code==JSON.parse(localStorage.getItem("code")))
    {
      ...
      form.append("email", JSON.parse(localStorage.getItem("form")).email);
      form.append("password", JSON.parse(localStorage.getItem("form")).password);
      form.append('status', "register");
